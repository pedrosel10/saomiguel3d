...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function Nh(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pc(),fragmentShader:`
...
`].filter(_r).join(`
`)),o=Nl(o),o=Xh(o,t),o=Yh(o,t),a=Nl(a),a=Xh(a,t),a=Yh(a,t),o=qh(o),a=qh(a),t.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`)+`
`+f);const S=x+m+o,y=x+f+a,w=Vh(i,i.VERTEX_SHADER,S),R=Vh(i,i.FRAGMENT_SHADER,y);i.attachShader(_,w),i.attachShader(_,R),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(P){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),D=i.getShaderInfoLog(w).trim(),B=i.getShaderInfoLog(R).trim();let z=!0,k=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(z=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,w,R);else{const X=Wh(i,w,"vertex"),V=Wh(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+O+`
`+X+`
`+V)}else O!==""?console.warn("THREE.WebGLProgram: Program Info Log:",O):(D===""||B==="")&&(k=!1);k&&(P.diagnostics={runnable:z,programLog:O,vertexShader:{log:D,prefix:m},fragmentShader:{log:B,prefix:f}})}i.deleteShader(w),i.deleteShader(R),E=new Lo(i,_),v=hx(i,_)}let E;this.getUniforms=function(){return E===void 0&&A(this),E};let v;this.getAttributes=function(){return v===void 0&&A(this),v};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=i.getProgramParameter(_,tx)),M},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=nx++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=w,this.fragmentShader=R,this}let Sx=0;class Ex{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Tx(e),t.set(e,n)),n}}class Tx{constructor(e){this.id=Sx++,this.code=e,this.usedTimes=0}}function bx(s,e,t,n,i,r,o){const a=new uc,l=new Ex,c=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures;let p=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(v){return c.add(v),v===0?"uv":`uv${v}`}function m(v,M,P,O,D){const B=O.fog,z=D.geometry,k=v.isMeshStandardMaterial?O.environment:null,X=(v.isMeshStandardMaterial?t:e).get(v.envMap||k),V=X&&X.mapping===qo?X.image.height:null,Q=g[v.type];v.precision!==null&&(p=i.getMaxPrecision(v.precision),p!==v.precision&&console.warn("THREE.WebGLProgram.getParameters:",v.precision,"not supported, using",p,"instead."));const te=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,he=te!==void 0?te.length:0;let ue=0;z.morphAttributes.position!==void 0&&(ue=1),z.morphAttributes.normal!==void 0&&(ue=2),z.morphAttributes.color!==void 0&&(ue=3);let Re,Y,J,me;if(Q){const Ke=In[Q];Re=Ke.vertexShader,Y=Ke.fragmentShader}else Re=v.vertexShader,Y=v.fragmentShader,l.update(v),J=l.getVertexShaderID(v),me=l.getFragmentShaderID(v);const se=s.getRenderTarget(),Ee=s.state.buffers.depth.getReversed(),Ce=D.isInstancedMesh===!0,De=D.isBatchedMesh===!0,Qe=!!v.map,we=!!v.matcap,ot=!!X,N=!!v.aoMap,hn=!!v.lightMap,Ve=!!v.bumpMap,Ge=!!v.normalMap,Te=!!v.displacementMap,at=!!v.emissiveMap,Me=!!v.metalnessMap,C=!!v.roughnessMap,T=v.anisotropy>0,H=v.clearcoat>0,$=v.dispersion>0,Z=v.iridescence>0,j=v.sheen>0,ve=v.transmission>0,oe=T&&!!v.anisotropyMap,de=H&&!!v.clearcoatMap,Xe=H&&!!v.clearcoatNormalMap,ee=H&&!!v.clearcoatRoughnessMap,fe=Z&&!!v.iridescenceMap,be=Z&&!!v.iridescenceThicknessMap,Pe=j&&!!v.sheenColorMap,pe=j&&!!v.sheenRoughnessMap,We=!!v.specularMap,Oe=!!v.specularColorMap,st=!!v.specularIntensityMap,I=ve&&!!v.transmissionMap,re=ve&&!!v.thicknessMap,q=!!v.gradientMap,K=!!v.alphaMap,ce=v.alphaTest>0,ae=!!v.alphaHash,Ne=!!v.extensions;let _t=Ri;v.toneMapped&&(se===null||se.isXRRenderTarget===!0)&&(_t=s.toneMapping);const Dt={shaderID:Q,shaderType:v.type,shaderName:v.name,vertexShader:Re,fragmentShader:Y,defines:v.defines,customVertexShaderID:J,customFragmentShaderID:me,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:p,batching:De,batchingColor:De&&D._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&D.instanceColor!==null,instancingMorph:Ce&&D.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:se===null?s.outputColorSpace:se.isXRRenderTarget===!0?se.texture.colorSpace:Lt,alphaToCoverage:!!v.alphaToCoverage,map:Qe,matcap:we,envMap:ot,envMapMode:ot&&X.mapping,envMapCubeUVHeight:V,aoMap:N,lightMap:hn,bumpMap:Ve,normalMap:Ge,displacementMap:d&&Te,emissiveMap:at,normalMapObjectSpace:Ge&&v.normalMapType===mp,normalMapTangentSpace:Ge&&v.normalMapType===cd,metalnessMap:Me,roughnessMap:C,anisotropy:T,anisotropyMap:oe,clearcoat:H,clearcoatMap:de,clearcoatNormalMap:Xe,clearcoatRoughnessMap:ee,dispersion:$,iridescence:Z,iridescenceMap:fe,iridescenceThicknessMap:be,sheen:j,sheenColorMap:Pe,sheenRoughnessMap:pe,specularMap:We,specularColorMap:Oe,specularIntensityMap:st,transmission:ve,transmissionMap:I,thicknessMap:re,gradientMap:q,opaque:v.transparent===!1&&v.blending===Cs&&v.alphaToCoverage===!1,alphaMap:K,alphaTest:ce,alphaHash:ae,combine:v.combine,mapUv:Qe&&_(v.map.channel),aoMapUv:N&&_(v.aoMap.channel),lightMapUv:hn&&_(v.lightMap.channel),bumpMapUv:Ve&&_(v.bumpMap.channel),normalMapUv:Ge&&_(v.normalMap.channel),displacementMapUv:Te&&_(v.displacementMap.channel),emissiveMapUv:at&&_(v.emissiveMap.channel),metalnessMapUv:Me&&_(v.metalnessMap.channel),roughnessMapUv:C&&_(v.roughnessMap.channel),anisotropyMapUv:oe&&_(v.anisotropyMap.channel),clearcoatMapUv:de&&_(v.clearcoatMap.channel),clearcoatNormalMapUv:Xe&&_(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ee&&_(v.clearcoatRoughnessMap.channel),iridescenceMapUv:fe&&_(v.iridescenceMap.channel),iridescenceThicknessMapUv:be&&_(v.iridescenceThicknessMap.channel),sheenColorMapUv:Pe&&_(v.sheenColorMap.channel),sheenRoughnessMapUv:pe&&_(v.sheenRoughnessMap.channel),specularMapUv:We&&_(v.specularMap.channel),specularColorMapUv:Oe&&_(v.specularColorMap.channel),specularIntensityMapUv:st&&_(v.specularIntensityMap.channel),transmissionMapUv:I&&_(v.transmissionMap.channel),thicknessMapUv:re&&_(v.thicknessMap.channel),alphaMapUv:K&&_(v.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(Ge||T),vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:D.isPoints===!0&&!!z.attributes.uv&&(Qe||K),fog:!!B,useFog:v.fog===!0,fogExp2:!!B&&B.isFogExp2,flatShading:v.flatShading===!0,sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:Ee,skinning:D.isSkinnedMesh===!0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:he,morphTextureStride:ue,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:v.dithering,shadowMapEnabled:s.shadowMap.enabled&&P.length>0,shadowMapType:s.shadowMap.type,toneMapping:_t,decodeVideoTexture:Qe&&v.map.isVideoTexture===!0&&ze.getTransfer(v.map.colorSpace)===et,decodeVideoTextureEmissive:at&&v.emissiveMap.isVideoTexture===!0&&ze.getTransfer(v.emissiveMap.colorSpace)===et,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===mn,flipSided:v.side===Yt,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:Ne&&v.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ne&&v.extensions.multiDraw===!0||De)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return Dt.vertexUv1s=c.has(1),Dt.vertexUv2s=c.has(2),Dt.vertexUv3s=c.has(3),c.clear(),Dt}function f(v){const M=[];if(v.shaderID?M.push(v.shaderID):(M.push(v.customVertexShaderID),M.push(v.customFragmentShaderID)),v.defines!==void 0)for(const P in v.defines)M.push(P),M.push(v.defines[P]);return v.isRawShaderMaterial===!1&&(x(M,v),S(M,v),M.push(s.outputColorSpace)),M.push(v.customProgramCacheKey),M.join()}function x(v,M){v.push(M.precision),v.push(M.outputColorSpace),v.push(M.envMapMode),v.push(M.envMapCubeUVHeight),v.push(M.mapUv),v.push(M.alphaMapUv),v.push(M.lightMapUv),v.push(M.aoMapUv),v.push(M.bumpMapUv),v.push(M.normalMapUv),v.push(M.displacementMapUv),v.push(M.emissiveMapUv),v.push(M.metalnessMapUv),v.push(M.roughnessMapUv),v.push(M.anisotropyMapUv),v.push(M.clearcoatMapUv),v.push(M.clearcoatNormalMapUv),v.push(M.clearcoatRoughnessMapUv),v.push(M.iridescenceMapUv),v.push(M.iridescenceThicknessMapUv),v.push(M.sheenColorMapUv),v.push(M.sheenRoughnessMapUv),v.push(M.specularMapUv),v.push(M.specularColorMapUv),v.push(M.specularIntensityMapUv),v.push(M.transmissionMapUv),v.push(M.thicknessMapUv),v.push(M.combine),v.push(M.fogExp2),v.push(M.sizeAttenuation),v.push(M.morphTargetsCount),v.push(M.morphAttributeCount),v.push(M.numDirLights),v.push(M.numPointLights),v.push(M.numSpotLights),v.push(M.numSpotLightMaps),v.push(M.numHemiLights),v.push(M.numRectAreaLights),v.push(M.numDirLightShadows),v.push(M.numPointLightShadows),v.push(M.numSpotLightShadows),v.push(M.numSpotLightShadowsWithMaps),v.push(M.numLightProbes),v.push(M.shadowMapType),v.push(M.toneMapping),v.push(M.numClippingPlanes),v.push(M.numClipIntersection),v.push(M.depthPacking)}function S(v,M){a.disableAll(),M.supportsVertexTextures&&a.enable(0),M.instancing&&a.enable(1),M.instancingColor&&a.enable(2),M.instancingMorph&&a.enable(3),M.matcap&&a.enable(4),M.envMap&&a.enable(5),M.normalMapObjectSpace&&a.enable(6),M.normalMapTangentSpace&&a.enable(7),M.clearcoat&&a.enable(8),M.iridescence&&a.enable(9),M.alphaTest&&a.enable(10),M.vertexColors&&a.enable(11),M.vertexAlphas&&a.enable(12),M.vertexUv1s&&a.enable(13),M.vertexUv2s&&a.enable(14),M.vertexUv3s&&a.enable(15),M.vertexTangents&&a.enable(16),M.anisotropy&&a.enable(17),M.alphaHash&&a.enable(18),M.batching&&a.enable(19),M.dispersion&&a.enable(20),M.batchingColor&&a.enable(21),v.push(a.mask),a.disableAll(),M.fog&&a.enable(0),M.useFog&&a.enable(1),M.flatShading&&a.enable(2),M.logarithmicDepthBuffer&&a.enable(3),M.reverseDepthBuffer&&a.enable(4),M.skinning&&a.enable(5),M.morphTargets&&a.enable(6),M.morphNormals&&a.enable(7),M.morphColors&&a.enable(8),M.premultipliedAlpha&&a.enable(9),M.shadowMapEnabled&&a.enable(10),M.doubleSided&&a.enable(11),M.flipSided&&a.enable(12),M.useDepthPacking&&a.enable(13),M.dithering&&a.enable(14),M.transmission&&a.enable(15),M.sheen&&a.enable(16),M.opaque&&a.enable(17),M.pointsUvs&&a.enable(18),M.decodeVideoTexture&&a.enable(19),M.decodeVideoTextureEmissive&&a.enable(20),M.alphaToCoverage&&a.enable(21),v.push(a.mask)}function y(v){const M=g[v.type];let P;if(M){const O=In[M];P=lm.clone(O.uniforms)}else P=v.uniforms;return P}function w(v,M){let P;for(let O=0,D=h.length;O<D;O++){const B=h[O];if(B.cacheKey===M){P=B,++P.usedTimes;break}}return P===void 0&&(P=new Mx(s,M,v,r),h.push(P)),P}function R(v){if(--v.usedTimes===0){const M=h.indexOf(v);h[M]=h[h.length-1],h.pop(),v.destroy()}}function A(v){l.remove(v)}function E(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:y,acquireProgram:w,releaseProgram:R,releaseShaderCache:A,programs:h,dispose:E}}function Ax(){let s=new WeakMap;function e(o){return s.has(o)}function t(o){let a=s.get(o);return a===void 0&&(a={},s.set(o,a)),a}function n(o){s.delete(o)}function i(o,a,l){s.get(o)[a]=l}function r(){s=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:r}}function wx(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function $h(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function Kh(){const s=[];let e=0;const t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function o(u,d,p,g,_,m){let f=s[e];return f===void 0?(f={id:u.id,object:u,geometry:d,material:p,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},s[e]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=_,f.group=m),e++,f}function a(u,d,p,g,_,m){const f=o(u,d,p,g,_,m);p.transmission>0?n.push(f):p.transparent===!0?i.push(f):t.push(f)}function l(u,d,p,g,_,m){const f=o(u,d,p,g,_,m);p.transmission>0?n.unshift(f):p.transparent===!0?i.unshift(f):t.unshift(f)}function c(u,d){t.length>1&&t.sort(u||wx),n.length>1&&n.sort(d||$h),i.length>1&&i.sort(d||$h)}function h(){for(let u=e,d=s.length;u<d;u++){const p=s[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:a,unshift:l,finish:h,sort:c}}function Rx(){let s=new WeakMap;function e(n,i){const r=s.get(n);let o;return r===void 0?(o=new Kh,s.set(n,[o])):i>=r.length?(o=new Kh,r.push(o)):o=r[i],o}function t(){s=new WeakMap}return{get:e,dispose:t}}function Cx(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new L,color:new Se};break;case"SpotLight":t={position:new L,direction:new L,color:new Se,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new L,color:new Se,distance:0,decay:0};break;case"HemisphereLight":t={direction:new L,skyColor:new Se,groundColor:new Se};break;case"RectAreaLight":t={color:new Se,position:new L,halfWidth:new L,halfHeight:new L};break}return s[e.id]=t,t}}}function Px(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ae};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ae};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ae,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}let Lx=0;function Dx(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function Ix(s){const e=new Cx,t=Px(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new L);const i=new L,r=new Ie,o=new Ie;function a(c){let h=0,u=0,d=0;for(let v=0;v<9;v++)n.probe[v].set(0,0,0);let p=0,g=0,_=0,m=0,f=0,x=0,S=0,y=0,w=0,R=0,A=0;c.sort(Dx);for(let v=0,M=c.length;v<M;v++){const P=c[v],O=P.color,D=P.intensity,B=P.distance,z=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)h+=O.r*D,u+=O.g*D,d+=O.b*D;else if(P.isLightProbe){for(let k=0;k<9;k++)n.probe[k].addScaledVector(P.sh.coefficients[k],D);A++}else if(P.isDirectionalLight){const k=e.get(P);if(k.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const X=P.shadow,V=t.get(P);V.shadowIntensity=X.intensity,V.shadowBias=X.bias,V.shadowNormalBias=X.normalBias,V.shadowRadius=X.radius,V.shadowMapSize=X.mapSize,n.directionalShadow[p]=V,n.directionalShadowMap[p]=z,n.directionalShadowMatrix[p]=P.shadow.matrix,x++}n.directional[p]=k,p++}else if(P.isSpotLight){const k=e.get(P);k.position.setFromMatrixPosition(P.matrixWorld),k.color.copy(O).multiplyScalar(D),k.distance=B,k.coneCos=Math.cos(P.angle),k.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),k.decay=P.decay,n.spot[_]=k;const X=P.shadow;if(P.map&&(n.spotLightMap[w]=P.map,w++,X.updateMatrices(P),P.castShadow&&R++),n.spotLightMatrix[_]=X.matrix,P.castShadow){const V=t.get(P);V.shadowIntensity=X.intensity,V.shadowBias=X.bias,V.shadowNormalBias=X.normalBias,V.shadowRadius=X.radius,V.shadowMapSize=X.mapSize,n.spotShadow[_]=V,n.spotShadowMap[_]=z,y++}_++}else if(P.isRectAreaLight){const k=e.get(P);k.color.copy(O).multiplyScalar(D),k.halfWidth.set(P.width*.5,0,0),k.halfHeight.set(0,P.height*.5,0),n.rectArea[m]=k,m++}else if(P.isPointLight){const k=e.get(P);if(k.color.copy(P.color).multiplyScalar(P.intensity),k.distance=P.distance,k.decay=P.decay,P.castShadow){const X=P.shadow,V=t.get(P);V.shadowIntensity=X.intensity,V.shadowBias=X.bias,V.shadowNormalBias=X.normalBias,V.shadowRadius=X.radius,V.shadowMapSize=X.mapSize,V.shadowCameraNear=X.camera.near,V.shadowCameraFar=X.camera.far,n.pointShadow[g]=V,n.pointShadowMap[g]=z,n.pointShadowMatrix[g]=P.shadow.matrix,S++}n.point[g]=k,g++}else if(P.isHemisphereLight){const k=e.get(P);k.skyColor.copy(P.color).multiplyScalar(D),k.groundColor.copy(P.groundColor).multiplyScalar(D),n.hemi[f]=k,f++}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ie.LTC_FLOAT_1,n.rectAreaLTC2=ie.LTC_FLOAT_2):(n.rectAreaLTC1=ie.LTC_HALF_1,n.rectAreaLTC2=ie.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const E=n.hash;(E.directionalLength!==p||E.pointLength!==g||E.spotLength!==_||E.rectAreaLength!==m||E.hemiLength!==f||E.numDirectionalShadows!==x||E.numPointShadows!==S||E.numSpotShadows!==y||E.numSpotMaps!==w||E.numLightProbes!==A)&&(n.directional.length=p,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=f,n.directionalShadow.length=x,n.directionalShadowMap.length=x,n.pointShadow.length=S,n.pointShadowMap.length=S,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=x,n.pointShadowMatrix.length=S,n.spotLightMatrix.length=y+w-R,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=A,E.directionalLength=p,E.pointLength=g,E.spotLength=_,E.rectAreaLength=m,E.hemiLength=f,E.numDirectionalShadows=x,E.numPointShadows=S,E.numSpotShadows=y,E.numSpotMaps=w,E.numLightProbes=A,n.version=Lx++)}function l(c,h){let u=0,d=0,p=0,g=0,_=0;const m=h.matrixWorldInverse;for(let f=0,x=c.length;f<x;f++){const S=c[f];if(S.isDirectionalLight){const y=n.directional[u];y.direction.setFromMatrixPosition(S.matrixWorld),i.setFromMatrixPosition(S.target.matrixWorld),y.direction.sub(i),y.direction.transformDirection(m),u++}else if(S.isSpotLight){const y=n.spot[p];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(S.matrixWorld),i.setFromMatrixPosition(S.target.matrixWorld),y.direction.sub(i),y.direction.transformDirection(m),p++}else if(S.isRectAreaLight){const y=n.rectArea[g];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(m),o.identity(),r.copy(S.matrixWorld),r.premultiply(m),o.extractRotation(r),y.halfWidth.set(S.width*.5,0,0),y.halfHeight.set(0,S.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),g++}else if(S.isPointLight){const y=n.point[d];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(m),d++}else if(S.isHemisphereLight){const y=n.hemi[_];y.direction.setFromMatrixPosition(S.matrixWorld),y.direction.transformDirection(m),_++}}}return{setup:a,setupView:l,state:n}}function Zh(s){const e=new Ix(s),t=[],n=[];function i(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function o(h){n.push(h)}function a(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function Nx(s){let e=new WeakMap;function t(i,r=0){const o=e.get(i);let a;return o===void 0?(a=new Zh(s),e.set(i,[a])):r>=o.length?(a=new Zh(s),o.push(a)):a=o[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}class Ad extends wn{static get type(){return"MeshDepthMaterial"}constructor(e){super(),this.isMeshDepthMaterial=!0,this.depthPacking=pp,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Ux extends wn{static get type(){return"MeshDistanceMaterial"}constructor(e){super(),this.isMeshDistanceMaterial=!0,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Fx=`void main() {
	gl_Position = vec4( position, 1.0 );
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	...
	value:`,o)}addColor(e,t,n=1){return new gS(this,e,t,n)}addFolder(e){const t=new Wc({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof qa||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof qa)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const i=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}function ES({camera:s,controls:e,lights:t,shadowFloorMat:n,modelState:i,defaultCameraPos:r}){var _,m;const o=document.getElementById("loader-screen");document.getElementById("progress-bar"),document.getElementById("progress-text");const a=performance.now(),l=f=>{const x=document.getElementById("orbit-2"),S=document.getElementById("orbit-3");x&&f>=30&&x.classList.add("active"),S&&f>=65&&S.classList.add("active")},c=f=>{if(!o){f&&f();return}setTimeout(()=>l(40),500),setTimeout(()=>l(75),1100);const x=2200,S=performance.now()-a,y=Math.max(0,x-S);setTimeout(()=>{l(100),o.classList.add("hidden"),setTimeout(()=>{f&&f()},200)},y)},h=new Wc({title:"⚙️ Controle de Cena & Iluminação"});h.domElement.style.top="24px",h.domElement.style.right="24px",h.hide();const u=(f,x,S,y,w,R,A,E)=>{const v=f.add(x,S,y,w,R).name(A);return setTimeout(()=>{if(v.domElement){const M=document.createElement("button");M.innerHTML="↺",M.title=`Resetar ${A} para o valor inicial (${E})`,M.style.cssText=`
        ...
        `,M.onmouseover=()=>M.style.color="#0066ff",M.onmouseout=()=>M.style.color="#94a3b8",M.onclick=P=>{P.stopPropagation(),x[S]=E,v.updateDisplay()},v.domElement.style.display="flex",v.domElement.style.alignItems="center",v.domElement.appendChild(M)}},10),v},d={copyConfig:()=>{var y;const f=(y=t.keyLight)==null?void 0:y.shadow,x={keyLight:t.keyLight?{intensity:t.keyLight.intensity,position:{x:t.keyLight.position.x,y:t.keyLight.position.y,z:t.keyLight.position.z}}:null,frontFillLight:t.frontFillLight?{intensity:t.frontFillLight.intensity,position:{x:t.frontFillLight.position.x,y:t.frontFillLight.position.y,z:t.frontFillLight.position.z}}:null,topLight:t.topLight?{intensity:t.topLight.intensity,position:{x:t.topLight.position.x,y:t.topLight.position.y,z:t.topLight.position.z}}:null,rimLight:t.rimLight?{intensity:t.rimLight.intensity,position:{x:t.rimLight.position.x,y:t.rimLight.position.y,z:t.rimLight.position.z}}:null,blueInnerLight:t.blueInnerLight?{intensity:t.blueInnerLight.intensity,position:{x:t.blueInnerLight.position.x,y:t.blueInnerLight.position.y,z:t.blueInnerLight.position.z}}:null,shadowConfig:{opacity:n?n.opacity:.45,radius:f?f.radius:2.5,bias:f?f.bias:-5e-4,normalBias:f?f.normalBias:.02},ambientLight:t.ambientLight?{intensity:t.ambientLight.intensity}:null,hemiLight:t.hemiLight?{intensity:t.hemiLight.intensity}:null},S=`### Configurações da Engrenagem 3D

\`\`\`json
${JSON.stringify(x,null,2)}
\`\`\``;navigator.clipboard.writeText(S).then(()=>{alert("📋 Configurações de iluminação e sombras copiadas!")}).catch(w=>{console.error("Erro ao copiar:",w),prompt("Copie as configurações abaixo:",S)})}};if(h.add(d,"copyConfig").name("📋 Copiar Configurações"),n||(_=t.keyLight)!=null&&_.shadow){const f=h.addFolder("🌑 Sombras do Chão");if(n&&u(f,n,"opacity",0,1,.02,"Opacidade da Sombra",n.opacity),(m=t.keyLight)!=null&&m.shadow){const x=t.keyLight.shadow;u(f,x,"radius",0,10,.2,"Suavidade (Radius)",x.radius),u(f,x,"bias",-.01,.01,1e-4,"Shadow Bias",x.bias),u(f,x,"normalBias",0,.2,.005,"Normal Bias",x.normalBias)}f.open()}if(t.keyLight){const f=t.keyLight.position,x=h.addFolder("💡 Key Light (Principal)");u(x,t.keyLight,"intensity",0,10,.1,"Intensidade",t.keyLight.intensity),u(x,f,"x",-20,20,.2,"Posição X",f.x),u(x,f,"y",-20,20,.2,"Posição Y",f.y),u(x,f,"z",-20,20,.2,"Posição Z",f.z),x.close()}if(t.frontFillLight){const f=t.frontFillLight.position,x=h.addFolder("🔆 Front Fill (Preenchimento)");u(x,t.frontFillLight,"intensity",0,10,.1,"Intensidade",t.frontFillLight.intensity),u(x,f,"x",-20,20,.2,"Posição X",f.x),u(x,f,"y",-20,20,.2,"Posição Y",f.y),u(x,f,"z",-20,20,.2,"Posição Z",f.z),x.close()}if(t.topLight){const f=t.topLight.position,x=h.addFolder("✨ Top Light (Superior)");u(x,t.topLight,"intensity",0,10,.1,"Intensidade",t.topLight.intensity),u(x,f,"x",-20,20,.2,"Posição X",f.x),u(x,f,"y",-20,20,.2,"Posição Y",f.y),u(x,f,"z",-20,20,.2,"Posição Z",f.z),x.close()}if(t.rimLight){const f=t.rimLight.position,x=h.addFolder("📐 Rim Light (Contorno)");u(x,t.rimLight,"intensity",0,10,.1,"Intensidade",t.rimLight.intensity),u(x,f,"x",-20,20,.2,"Posição X",f.x),u(x,f,"y",-20,20,.2,"Posição Y",f.y),u(x,f,"z",-20,20,.2,"Posição Z",f.z),x.close()}if(t.blueInnerLight){const f=t.blueInnerLight.position,x=h.addFolder("🔷 Luz Azul Interna");u(x,t.blueInnerLight,"intensity",0,150,1,"Intensidade",t.blueInnerLight.intensity),u(x,f,"x",-5,5,.1,"Posição X",f.x),u(x,f,"y",-5,5,.1,"Posição Y",f.y),u(x,f,"z",-5,5,.1,"Posição Z",f.z),x.open()}const p=h.addFolder("🌍 Luz Ambiente Global");return t.ambientLight&&u(p,t.ambientLight,"intensity",0,3,.05,"Ambiente",t.ambientLight.intensity),t.hemiLight&&u(p,t.hemiLight,"intensity",0,3,.05,"Hemisfério",t.hemiLight.intensity),p.close(),{updateProgress:l,hideLoader:c,gui:h,bindMaterialControls:f=>{if(!f)return;const x=h.addFolder("🎨 Material da Engrenagem (PBR)"),S={color:"#"+f.color.getHexString()};if(x.addColor(S,"color").name("Cor Base").onChange(y=>{f.color.set(y)}),u(x,f,"metalness",0,1,.01,"Metalness (Metálico)",f.metalness),u(x,f,"roughness",0,1,.01,"Roughness (Rugosidade)",f.roughness),u(x,f,"clearcoat",0,1,.01,"Clearcoat (Verniz)",f.clearcoat),u(x,f,"clearcoatRoughness",0,1,.01,"Clearcoat Roughness",f.clearcoatRoughness),u(x,f,"envMapIntensity",0,10,.1,"Reflexo HDRI (EnvMap)",f.envMapIntensity),f.normalScale){const y={scale:f.normalScale.x};u(x,y,"scale",0,5,.1,"Normal Scale (Relevo)",f.normalScale.x).onChange(w=>{f.normalScale.set(w,w)})}x.open()}}}function TS(s,e){const n=new Jt,i=new Float32Array(180*3),r=new Float32Array(180*3),o=new Float32Array(180),a=new Float32Array(180),l=new Float32Array(180),c=document.createElement("canvas");c.width=64,c.height=64;const h=c.getContext("2d"),u=h.createRadialGradient(32,32,0,32,32,32);u.addColorStop(0,"rgba(255, 255, 255, 1)"),u.addColorStop(.25,"rgba(255, 180, 50, 0.9)"),u.addColorStop(.6,"rgba(255, 80, 0, 0.6)"),u.addColorStop(1,"rgba(255, 0, 0, 0)"),h.fillStyle=u,h.beginPath(),h.arc(32,32,32,0,Math.PI*2),h.fill();const d=new cv(c),p=new vc({size:.22,map:d,transparent:!0,blending:ja,depthWrite:!1,color:new Se(16759620)});for(let f=0;f<180;f++)a[f]=0,l[f]=.3+Math.random()*.5,o[f]=.08+Math.random()*.15,i[f*3]=0,i[f*3+1]=-999,i[f*3+2]=0;n.setAttribute("position",new xt(i,3)),n.setAttribute("size",new xt(o,1));const g=new Cd(n,p);s.add(g);function _(f,x){const S=Math.random()*Math.PI*2,y=1+Math.random()*1.2;i[f*3]=Math.cos(S)*y,i[f*3+1]=x+(Math.random()-.5)*.08,i[f*3+2]=Math.sin(S)*y;const w=1.5+Math.random()*3,R=1+Math.random()*3.5;r[f*3]=(Math.cos(S)+(Math.random()-.5)*.8)*w,r[f*3+1]=R,r[f*3+2]=(Math.sin(S)+(Math.random()-.5)*.8)*w,a[f]=l[f]}function m(f){if(!e||!e.uBuildProgress)return;const x=e.uBuildProgress.value,S=x>.01&&x<.99,y=e.uMinY?e.uMinY.value:-1.75,w=e.uMaxY?e.uMaxY.value:1.75,R=zr.lerp(y,w,x),A=n.attributes.position;for(let E=0;E<180;E++)a[E]>0?(a[E]-=f,i[E*3]+=r[E*3]*f,i[E*3+1]+=r[E*3+1]*f,i[E*3+2]+=r[E*3+2]*f,r[E*3+1]-=9.8*f):S&&Math.random()<.4?_(E,R):i[E*3+1]=-999;A.needsUpdate=!0}return{update:m}}function bS(s,e,t,n){const i=[{id:"equipe",label:"NOSSA EQUIPE",sublabel:"Profissionais & Especialistas",side:"left",isTop:!0},{id:"servicos",label:"NOSSOS SERVIÇOS",sublabel:"Soluções Integradas 3D",side:"right",isTop:!0},{id:"cases",label:"CASES DE CLIENTES",sublabel:"Projetos e Sucessos",side:"left",isTop:!1},{id:"contato",label:"FALE CONOSCO",sublabel:"Atendimento & Orçamentos",side:"right",isTop:!1}];function r(E){return E.split("").map(v=>v===" "?'<span class="char space">&nbsp;</span>':`<span class="char">${v}</span>`).join("")}function o(E){const v=window.innerWidth,M=window.innerHeight,P=v<=768||v/M<1;let O=E.isTop?P?.28:.3:P?.72:.7;return E.id==="servicos"?O+=P?.05:.04:E.id==="cases"&&(O-=P?.05:.04),{x:P?E.side==="left"?v*.1:v*.9:E.side==="left"?v*.3:v*.7,y:M*O}}let a=document.getElementById("callouts-overlay");a||(a=document.createElement("div"),a.id="callouts-overlay",a.className="callouts-overlay",a.innerHTML='<div class="callouts-nodes-layer" id="callouts-nodes-layer"></div>',document.body.appendChild(a));const l=document.getElementById("callouts-nodes-layer");l.innerHTML="";const c=i.map(E=>{const v=document.createElement("div");v.className=`callout-card callout-${E.side}`,v.id=`callout-node-${E.id}`;const M=o(E);v.style.left=`${M.x}px`,v.style.top=`${M.y}px`;const P=r(E.label);return v.innerHTML=`
      <div class="callout-content-box">
        <div class="holo-scan-line"></div>
        <h3 class="callout-title">${P}</h3>
      </div>
    `,v.addEventListener("click",()=>{console.log(`[Callout] Seção clicada: ${E.label}`),window.dispatchEvent(new CustomEvent("calloutClick",{detail:E}))}),l.appendChild(v),{data:E,element:v}});window.addEventListener("resize",()=>{c.forEach(({data:E,element:v})=>{const M=o(E);v.style.left=`${M.x}px`,v.style.top=`${M.y}px`}),w(0)});const h={uBuildProgress:{value:0},uTime:{value:0}},u=new Hn({uniforms:h,transparent:!0,depthTest:!0,depthWrite:!1,vertexShader:`
    ...
    `}),d=new oi;d.name="CalloutLines3DGroup";const p=i.map(()=>{const E=new Jt,v=new Float32Array(3*3);E.setAttribute("position",new xt(v,3));const M=new Float32Array([0,.5,1]);E.setAttribute("aProgress",new xt(M,1));const P=new Vr(E,u);return d.add(P),{lineMesh:P,geo:E}});s.add(d);const g=new L,_=new L,m=new L,f=new L,x=new Dn,S=new Vv,y=new Ae;function w(E=.016){if(!e||!t)return;h.uTime.value+=E;const v=window.innerWidth,M=window.innerHeight;n&&n.mesh?n.mesh.localToWorld(g.set(0,0,0)):g.set(0,0,0);const P=g.clone().project(e),O=(P.x*.5+.5)*v,D=(-P.y*.5+.5)*M;e.getWorldDirection(f),x.setFromNormalAndCoplanarPoint(f.negate(),g);function B(z,k,X){y.set(z/v*2-1,-(k/M)*2+1),S.setFromCamera(y,e),S.ray.intersectPlane(x,X)}c.forEach(({data:z,element:k},X)=>{const V=v<=768||v/M<1,Q=z.side==="left",te=z.isTop;let he,ue,Re,Y;if(V&&k&&k.offsetWidth>0){const we=k.getBoundingClientRect();he=we.left+we.width/2,te?ue=we.bottom+6:ue=we.top-6;const ot=Q?z.id==="equipe"?-115:-90:110,N=te?.15:.72;Re=O+ot,Y=D+(ue-D)*N}else if(V){const we=o(z);he=Q?we.x+35:we.x-35,ue=te?we.y+14:we.y-14;const ot=Q?z.id==="equipe"?-115:-90:110,N=te?.15:.72;Re=O+ot,Y=D+(ue-D)*N}else{const we=o(z);he=we.x,ue=we.y,Re=O+(Q?-180:180),Y=ue}B(Re,Y,m),B(he,ue,_);const J=g.distanceTo(m),me=m.distanceTo(_),se=J+me,Ee=se>0?J/se:.5,{geo:Ce}=p[X],De=Ce.attributes.position;De.setXYZ(0,g.x,g.y,g.z),De.setXYZ(1,m.x,m.y,m.z),De.setXYZ(2,_.x,_.y,_.z),De.needsUpdate=!0;const Qe=Ce.attributes.aProgress;Qe.setX(0,0),Qe.setX(1,Ee),Qe.setX(2,1),Qe.needsUpdate=!0})}function R(E){const v=[...E];for(let M=v.length-1;M>0;M--){const P=Math.floor(Math.random()*(M+1));[v[M],v[P]]=[v[P],v[M]]}return v}function A(){const E=Gc.timeline({delay:1});return E.to(h.uBuildProgress,{value:1,duration:1.8,ease:"power2.inOut"},0),c.forEach(({element:v},M)=>{const P=v.querySelector(".callout-content-box"),O=v.querySelector(".holo-scan-line"),D=Array.from(v.querySelectorAll(".callout-title .char:not(.space)"));v.style.opacity="1";const B=1.1+M*.18;if(P&&O){const z={progress:0};E.to(O,{opacity:1,duration:.08},B),E.to(z,{progress:100,duration:.7,ease:"power2.out",onUpdate:()=>{const k=100-z.progress;P.style.clipPath=`inset(${k}% 0 0 0)`,O.style.top=`${k}%`}},B),E.to(O,{opacity:0,duration:.25},B+.6)}if(D.length>0){const z=R(D);E.to(z,{opacity:1,y:0,duration:.08,stagger:.03,ease:"power1.out",onStart:function(){const k=this.targets?this.targets()[0]:null;k&&(k.classList.add("holo-glow"),setTimeout(()=>k.classList.remove("holo-glow"),250))}},B+.12)}}),E}return{update:w,animateIn:A,lineUniforms:h}}function AS(){const s=document.getElementById("webgl-canvas");if(!s)return;const{scene:e,camera:t,renderer:n,floor:i,shadowFloorMat:r,ISOMETRIC_POS:o,updateResponsiveCamera:a}=sy(s),l=oy(e,n),c=new Xv(t,n.domElement);c.enableDamping=!0,c.dampingFactor=.05,c.enableRotate=!1,c.enablePan=!1,c.enableZoom=!1,c.target.set(0,0,0);const h={mesh:null};let u=null,d=null,p=null;const g={xVelocity:0,xAngle:0};window.addEventListener("wheel",S=>{g.xVelocity+=S.deltaY*18e-5},{passive:!0});const _={x:0,targetX:0,targetY:0};window.addEventListener("mousemove",S=>{_.targetX=(S.clientX/window.innerWidth-.5)*2,_.targetY=(S.clientY/window.innerHeight-.5)*2});const m=ES({camera:t,controls:c,lights:l,shadowFloorMat:r,modelState:h,defaultCameraPos:o});Wy(e,S=>{m.updateProgress(S)},(S,y,w,R,A)=>{h.mesh=S,d=A,p=bS(e,t,n,h);const E=120,v=200,M=new Float32Array(v*3);for(let z=0;z<v;z++){const k=z/(v-1)*2-1;M[z*3]=0,M[z*3+1]=0,M[z*3+2]=k*(E/2)}const P=new Jt;P.setAttribute("position",new xt(M,3));const O={uTime:{value:0},uBuildProgress:{value:0}},D=new Hn({uniforms:O,transparent:!0,depthWrite:!1,vertexShader:`
          uniform float uTime;
          uniform float uBuildProgress;
          varying float vT;
          varying vec3 vWorldPos;
        ...
        `}),B=new Vr(P,D);B.userData={uniforms:O},S.add(B),R&&(R.axisLineUniforms=O),w&&m.bindMaterialControls(w),R&&(u=TS(e,R)),m.hideLoader(()=>{hS(t,l,c,R,r),p&&p.animateIn()})},S=>{console.error("Falha ao inicializar o modelo:",S),m.hideLoader()}),window.addEventListener("resize",()=>{a(t,e,i,r),n.setSize(window.innerWidth,window.innerHeight),n.setPixelRatio(Math.min(window.devicePixelRatio,2))});const f=new Dv;function x(){requestAnimationFrame(x);const S=f.getDelta();_.x+=(_.targetX-_.x)*.015;const y=.33,w=Math.abs(g.xAngle)/y,R=Math.pow(1-Math.min(w,.99),1.8);if(g.xAngle+=g.xVelocity*R,g.xVelocity*=.92,g.xAngle+=(0-g.xAngle)*.045,g.xAngle=zr.clamp(g.xAngle,-y,y),h.mesh){h.mesh.rotation.y=_.x*Math.PI*.036;const A=g.xAngle*1.5;h.mesh.rotation.z=-A,h.mesh.position.set(0,0,0)}d&&(d.uCoreRotationX.value=g.xAngle),h.mesh&&h.mesh.traverse(A=>{A.userData&&A.userData.uniforms&&A.userData.uniforms.uTime&&(A.userData.uniforms.uTime.value+=S)}),u&&u.update(S),p&&p.update(S),c.update(),n.render(e,t)}x()}window.addEventListener("DOMContentLoaded",AS);
//# sourceMappingURL=index-CcPTJE08.js.map
